...
bp = Blueprint('ten_chall', __name__, url_prefix='/ten_chall', template_folder='templates/template_ten/')

CHALL_ID = 10   # <--- ID della tua challenge
ID = 0
...
# Path JSON generati con deploy_chall.sh
json_path = './jsons/ten_chall_json/'
...
def ten_chall():
    ...
    if r:
        return render_template('ten_chall.html')
    else:
...
def strings():
    ...
    if r:
        return render_template('strings_10.html')
    else:
        return render_template('cannot_access.html')
...
def confirm_solution():
    if request.method == 'GET':
        ...
        if r:
            return render_template("confirm_solution_10.html")
        else:
            return render_template("cannot_access.html")
...
def callgraph():
    ...
    if r:
        return render_template("callgraph_10.html")
    else:
        return render_template("cannot_access.html")
...
def info():
    ...
    if r:
        return render_template("info_10.html")
    else:
        return render_template("cannot_access.html")
